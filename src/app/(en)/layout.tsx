...
export const metadata: Metadata = {
  ...
  title: {
    default: `${site.name} — Run Your Cleaning Business From a Google Sheet`,
  ...
  keywords: [
    ...
    "Google Sheets cleaning template",
    "Jobber alternative",
    "Housecall Pro alternative",
    "ZenMaid alternative",
    "small cleaning business CRM",
    "cleaning business app",
    "solo cleaner software",
  ],
  alternates: {
  ...
  openGraph: {
    ...
    url: localeUrl("en"),
    siteName: site.name,
    title: `${site.name} — Run Your Cleaning Business From a Google Sheet`,
    description: t.hero_sub,
    images: [
      {
        url: "/opengraph-image",
        width: 1200,
        height: 630,
        alt: `${site.name} — cleaning business template`,
      },
    ],
  },
  twitter: {
